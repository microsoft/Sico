...
func newTUser(db *gorm.DB, opts ...gen.DOOption) tUser {
	...
	_tUser.Alias_ = field.NewString(tableName, "alias")
	...
	_tUser.Tenant = field.NewString(tableName, "tenant")
	_tUser.Phone = field.NewString(tableName, "phone")
	_tUser.IconURI = field.NewString(tableName, "icon_uri")
	_tUser.Status = field.NewInt32(tableName, "status")
	_tUser.Description = field.NewString(tableName, "description")
	_tUser.CreatedAt = field.NewInt64(tableName, "created_at")
	_tUser.UpdatedAt = field.NewInt64(tableName, "updated_at")
...
type tUser struct {
	...
	Alias_      field.String // Name of user
	Username    field.String // Username for login
	Password    field.String // Password for login (MD5 hashed)
	Email       field.String // Email address
	Tenant      field.String // Tenant
	Phone       field.String // Phone number
	IconURI     field.String // Icon URI
	Status      field.Int32  // Status of user (inactive, active, freeze)
