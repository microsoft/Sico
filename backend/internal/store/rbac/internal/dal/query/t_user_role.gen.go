...
func newTUserRole(db *gorm.DB, opts ...gen.DOOption) tUserRole {
	_tUserRole := tUserRole{}

	_tUserRole.tUserRoleDo.UseDB(db, opts...)
...
func (t tUserRole) clone(db *gorm.DB) tUserRole {
	t.tUserRoleDo.ReplaceConnPool(db.Statement.ConnPool)
	return t
}

func (t tUserRole) replaceDB(db *gorm.DB) tUserRole {
...
type ITUserRoleDo interface {
	...
	ReadDB() ITUserRoleDo
	WriteDB() ITUserRoleDo
	As(alias string) gen.Dao
	Session(config *gorm.Session) ITUserRoleDo
...
func (t tUserRoleDo) Session(config *gorm.Session) ITUserRoleDo {
