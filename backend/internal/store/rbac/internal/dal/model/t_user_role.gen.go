...
type TUserRole struct {
	...
	ScopeID   string         `gorm:"column:scope_id;not null;default:0;comment:Scope identifier: org/project numeric ID or agent UUID (0 for platform scope)" json:"scope_id"` // Scope identifier: org/project numeric ID or agent UUID (0 for platform scope)
