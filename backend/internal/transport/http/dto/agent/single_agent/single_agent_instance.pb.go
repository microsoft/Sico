...
type SingleAgentInstance struct {
	...
	ConversationStatus *common.ConversationRunStatus `protobuf:"varint,28,opt,name=conversation_status,json=conversationStatus,proto3,enum=common.ConversationRunStatus,oneof" json:"conversationStatus,omitempty"`  
...
func (x *SingleAgentInstance) GetConversationStatus() common.ConversationRunStatus {
	if x != nil && x.ConversationStatus != nil {
		return *x.ConversationStatus
	}
	return common.ConversationRunStatus(0)
}
...
type ListSingleAgentInstancesFilter struct {
	...
	FetchConversationStatus bool                        `protobuf:"varint,11,opt,name=fetch_conversation_status,json=fetchConversationStatus,proto3" json:"fetch_conversation_status,omitempty" form:"fetchConversationStatus"`                 
	unknownFields           protoimpl.UnknownFields
	sizeCache               protoimpl.SizeCache
}
...
func (x *ListSingleAgentInstancesFilter) GetFetchConversationStatus() bool {
	if x != nil {
...
const file_agent_single_agent_instance_proto_rawDesc = "" +
	"\n" +
	"!agent/single_agent_instance.proto\x12\x15single_agent_instance\x1a\x13common/common.proto\x1a\x15project/project.proto\"\xc3\x06\n" +
	...
	"\tsandboxes\x18\x1b \x03(\v2\x15.common.SandboxDigestR\tsandboxes\x12S\n" +
	"\x13conversation_status\x18\x1c \x01(\x0e2\x1d.common.ConversationRunStatusH\x00R\x12conversationStatus\x88\x01\x01B\x16\n" +
	"\x14_conversation_statusJ\x04\b\x13\x10\x14\"\xef\x02\n" +
	...
	"\x04code\x18\xfd\x01 \x01(\x05R\x04code\x12\x11\n" +
	"\x03msg\x18\xfe\x01 \x01(\tR\x03msg\"\xc2\x04\n" +
	...
	" \x01(\tH\x02R\x10operatorUsername\x88\x01\x01\x12:\n" +
	"\x19fetch_conversation_status\x18\v \x01(\bR\x17fetchConversationStatusB\x14\n" +
...
var file_agent_single_agent_instance_proto_goTypes = []any{
	...
	(common.ConversationRunStatus)(0),               // 26: common.ConversationRunStatus
	(common.SortOrder)(0),                           // 27: common.SortOrder
}
var file_agent_single_agent_instance_proto_depIdxs = []int32{
	...
	26, // 4: single_agent_instance.SingleAgentInstance.conversation_status:type_name -> common.ConversationRunStatus
	23, // 5: single_agent_instance.CreateSingleAgentInstanceRequest.attachments:type_name -> common.Attachment
	5,  // 6: single_agent_instance.CreateSingleAgentInstanceResponse.data:type_name -> single_agent_instance.CreateSingleAgentInstanceData
	8,  // 7: single_agent_instance.GetSingleAgentInstanceResponse.data:type_name -> single_agent_instance.GetSingleAgentInstanceData
	2,  // 8: single_agent_instance.GetSingleAgentInstanceData.instance:type_name -> single_agent_instance.SingleAgentInstance
	23, // 9: single_agent_instance.UpdateSingleAgentInstanceRequest.attachments:type_name -> common.Attachment
	0,  // 10: single_agent_instance.UpdateSingleAgentInstanceStatusRequest.status:type_name -> single_agent_instance.SingleAgentInstanceStatus
	0,  // 11: single_agent_instance.ListSingleAgentInstancesFilter.status_arr:type_name -> single_agent_instance.SingleAgentInstanceStatus
	1,  // 12: single_agent_instance.ListSingleAgentInstancesFilter.order_by:type_name -> single_agent_instance.SingleAgentInstanceOrderBy
	27, // 13: single_agent_instance.ListSingleAgentInstancesFilter.sort_order:type_name -> common.SortOrder
	21, // 14: single_agent_instance.ListSingleAgentInstancesResponse.data:type_name -> single_agent_instance.ListSingleAgentInstancesData
	2,  // 15: single_agent_instance.ListSingleAgentInstancesData.instances:type_name -> single_agent_instance.SingleAgentInstance
	0,  // 16: single_agent_instance.ListSingleAgentInstanceFilter.status_arr:type_name -> single_agent_instance.SingleAgentInstanceStatus
	1,  // 17: single_agent_instance.ListSingleAgentInstanceFilter.order_by:type_name -> single_agent_instance.SingleAgentInstanceOrderBy
	27, // 18: single_agent_instance.ListSingleAgentInstanceFilter.sort_order:type_name -> common.SortOrder
...
func file_agent_single_agent_instance_proto_init() {
	...
	file_agent_single_agent_instance_proto_msgTypes[0].OneofWrappers = []any{}
