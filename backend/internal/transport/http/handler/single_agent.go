...
// PublishSingleAgent changes a single agent's publish status.
// @Router /api/sico/agent/single_agent/publish [POST]
// @Tags SingleAgent
// @Accept json
// @Produce json
// @Param request body single_agent.PublishSingleAgentRequest true "Change single agent publish status request"
