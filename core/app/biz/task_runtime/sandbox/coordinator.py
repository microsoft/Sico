...
from ..orchestration.run_support import await_unless_plan_cancelled, is_plan_cancelled, wait_for_plan_cancelled
...
from ..presentation.events import (
    DeliverableSpec,
...
from .lease_manager import ReverseGrpcSandboxLeaseManager, SandboxLeaseManager
...
class SandboxCoordinator:
    ...
    async def acquire(self, ctx: TurnContext, run: TaskRun) -> None:
        ...
        requirement = run.spec.selected_sandbox
