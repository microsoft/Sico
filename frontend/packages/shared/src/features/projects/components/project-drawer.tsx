          ...
          <div className="flex flex-wrap gap-2">
            {knowledgeTags
              ...
              .map((knowledgeTag) => (
                <span
                  key={knowledgeTag.id}
                  className="bg-surface-muted text-foreground-secondary leading-body inline-flex h-6 shrink-0 items-center justify-center rounded-sm px-2 py-1 text-xs font-medium tracking-wider whitespace-nowrap"
                >
                  {knowledgeTag.name}
                </span>
              ))}
