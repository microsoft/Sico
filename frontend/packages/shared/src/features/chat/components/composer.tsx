...
export function Composer({
  ...
  return (
    <div className="mx-auto flex w-full max-w-190 flex-col gap-2 px-4 pb-5">
      ...
      <InputGroup
        onPaste={handlePaste}
        className="bg-surface-basic border-divider hover:border-input-stroke-rest focus-within:border-input-stroke-rest shadow-m focus-within:shadow-l has-disabled:bg-surface-basic has-disabled:border-divider has-[[data-slot=input-group-control]:focus-visible]:border-input-stroke-rest has-[[data-slot=input-group-control]:focus-visible]:shadow-l min-h-30 rounded-2xl border pt-4 transition"
      >
