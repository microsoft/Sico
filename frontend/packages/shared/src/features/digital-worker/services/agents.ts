...
export async function fetchAgents(
  ...
  const res = await apiClient.get<unknown>(
    AGENT_ENDPOINTS.singleAgentInstances,
    {
      params: {
        page,
...
export async function fetchAgentDetail(
  ...
  const res = await apiClient.get<unknown>(
    AGENT_ENDPOINTS.singleAgentInstance,
    {
      params: { id: agentId },
    },
  );
...
export async function updateAgentInstanceStatus(
  ...
  const response = await apiClient.put<unknown>(
    AGENT_ENDPOINTS.singleAgentInstanceStatus,
    { id, status },
  );
...
export async function dismissAgentInstance(
  ...
  const response = await apiClient.post<unknown>(
    AGENT_ENDPOINTS.singleAgentInstanceDismiss,
    { id },
  );
  assertOk(
...
export async function reassignAgentInstance(
  ...
  const response = await apiClient.post<unknown>(
    AGENT_ENDPOINTS.singleAgentInstanceReassign,
