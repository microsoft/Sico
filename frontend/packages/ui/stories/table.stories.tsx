          ...
          <TableHead className="w-30">
            <span className="inline-flex items-center gap-1">
              ...
              <Button
                variant="subtle"
                size="icon-xs"
                className="hover:text-foreground-primary text-foreground-tertiary hover:bg-transparent"
              >
          ...
          <TableHead className="text-right">
            <span className="relative inline-flex items-center">
              ...
              <Button
                variant="subtle"
                size="icon-xs"
                className="hover:text-foreground-primary text-foreground-tertiary absolute -right-6 hover:bg-transparent"
              >
                <ArrowUpDownIcon className="size-3.5" />
              </Button>
            </span>
